...
export default function Producers() {
    ...
    function handleSubmit(e: FormEvent<HTMLFormElement>) {
        ...
        const data = {
            ...
            address_road: (form.elements.namedItem('address_road') as HTMLInputElement).value,
    ...
    return (
        ...
        >
            <div className="mb-4 flex items-center gap-4">
                ...
                />
                {isAdmin && (
                    <PrimaryButton onClick={() => handleEdit()}>Ajouter</PrimaryButton>
                )}
            </div>
                                ...
                                <div className="flex flex-col justify-between">
                                    ...
                                    {isAdmin && (
                                        <div className="mt-2 flex gap-2">
                                            <SecondaryButton onClick={() => handleEdit(p)}>
                                                Modifier
                                            </SecondaryButton>
            ...
            <Modal show={showModal} onClose={() => setShowModal(false)}>
                <form onSubmit={handleSubmit} className="space-y-4 p-6">
                    ...
                    <div className="flex justify-end gap-2 pt-4">
                        ...
                        <DangerButton type="button" onClick={() => setShowModal(false)}>
                            Annuler
                        </DangerButton>
                    </div>
                </form>
